        ...
        public static void Seed(ApplicationDbContext db)
        {
            ...
            var cars = new List<Car>
            {
                new Car
                {
                    ...
                    Description="Добре поддържана, сервизна история. -Test",
                ...
                new Car
                {
                    ...
                    Description="Европейски автомобил, реални километри. -Test",
                ...
                new Car
                {
                    ...
                    Description="Икономична, идеална за град. -Test",
                ...
                new Car
                {
                    ...
                    Description="Стегната и комфортна, подходяща за пътувания. -Test",
                ...
                new Car
                {
                    ...
                    Description="Комфорт и класа. Внос, обслужена. -Test",
                ...
                new Car
                {
                    ...
                    Description="Практична и икономична. -Test",
                ...
                new Car
{
    ...
    Description="Практичен хечбек, отличен разход. -Test",
...
new Car
{
    ...
    Description="SUV в отлично състояние, просторен и комфортен. -Test",
...
new Car
{
    ...
    Description="Елегантен седан, много добро оборудване. -Test",
...
new Car
{
    ...
    Description="Напълно електрически, автопилот, минимален разход. -Test",
...
new Car
{
    ...
    Description="Поддържан автомобил, икономичен и надежден. -Test",
